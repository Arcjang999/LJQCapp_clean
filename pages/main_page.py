...
2. 在首页点击“新建项目”，选择仪器和质控品，再添加检验项目。各检验项目可分别选择方法学、试剂、单位、质控方式及输入值类型，并设置质量目标。
3. 点击“新增批次”，选择各水平的质控品批号，填写均值和标准差，或设置建立均值和标准差所需的数据点数。选择适用的质量标准；没有适用标准时，填写实验室自定要求及依据。完成检查后确认批次设置。
...
1. 进入“单水平（LJ）”，选择设置已确认的项目与批次，再打开“当前批次”。
